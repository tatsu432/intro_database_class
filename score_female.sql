...
SELECT MD02.Code AS Code, MD02.Prefecture AS Prefecture, MD02.score + MD15.score + MD23.score + MD24.score AS score_art_female
FROM MD02
    INNER JOIN MD15
...
SELECT MD26.Code AS Code, MD26.Prefecture AS Prefecture, MD26.score + MD27.score AS score_literature_female
...
SELECT MD06.Code AS Code, MD06.Prefecture AS Prefecture, MD06.score + MD07.score + MD08.score + MD09.score + MD10.score + MD11.score AS score_music_female
FROM MD06
    INNER JOIN MD07
...
SELECT MD03.Code AS Code, MD03.Prefecture AS Prefecture, MD03.score + MD04.score + MD05.score + MD13.score + MD14.score AS score_theater_female
FROM MD03
    INNER JOIN MD04
...
SELECT MD16.Code AS Code, MD16.Prefecture AS Prefecture, MD16.score + MD17.score + MD25.score AS score_else_female
FROM MD16 
    INNER JOIN MD17 
